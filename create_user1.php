...
<body>
    ...
    <form method="post" action="create_user1.php">
    ...
    <div class="container mt-3">
        <div class="text-center mb-5 mt-5">
            ...
            <p>Por favor, preencha todos os campos abaixo.
            <br>Esse cadastro já é meio caminho andado para utilizar o
                Gestão Central!</p>
            ...
            <div class="carousel-inner">
                    <div class="carousel-item active" id="1">
                        <div class="col-md-4 col-sm-12 offset-lg-4 offset-md-4 mb-3 form-style" id="meuForm">
                            ...
                            <input class="form-control" type="text" name="username" id="nome" onblur="validaNome()"
                            ...
                            <input class="form-control col-md-6 col-sm-6" type="password" name="password_2"
                    ...
                    <div class="carousel-item" id="2">
                        <div class="col-md-4
                            ...
                            <label class="titulo" for="validationCustom04">CNPJ/CPF</label>
                ...
                <div class="carousel-item" id="3">
                    <div class="col-md-6 col-sm-12 offset-lg-3 offset-md-2 mb-3 form-style">

                            <label class="titulo" for="validationCustom05">CEP</label>
                            <input class="form-control" type="text" id="cep" onblur="pesquisacep(this.value);">
                            <small><span class="helper-text mb-4"></span></small><br>
                ...
                <div class="col-md-4 col-sm-12 offset-lg-4 offset-md-4 mb-3">
                    ...
                    <button class="btn btn-sm col-sm-9 float-right mb-5" href="#myCarousel" data-slide="next"
                        id="continuar" style="display:inline; background-color: #80179b; color: White" type="button">Continuar</button>
                    <button class="btn btn-sm col-sm-9 float-left mb-5" href="#myCarousel" data-slide="prev"
                        id="voltar" style="display: none; background-color: #80179b; color: White">Voltar</button>
        ...
        <div class="input-group">
		    ...
		    <button style="color:White" type="submit" class="btn" name="register_btn"> + Criar Usuário</button>
		</div>
